...
const AdminRegisterPage = () => {
  ...
  const StyledGrid = styled(Grid)`
    ...
    background-color: #fff; /* Example custom background color */
    padding: 20px; /* Example custom padding */

    /* Example media query */
    @media (max-width: 600px) {
      /* Example background color for larger screens */
      padding: 0px; /* Example increased padding for larger screens */
    }
  `;
    ...
    <ThemeProvider theme={defaultTheme}>
      ...
      >
        ...
        {/* <div style={{ height: "100%", display: "flex", alignItems: "end" }}>
          <img className="boyImage" src="/boy.png" alt="" />
        </div> */}
