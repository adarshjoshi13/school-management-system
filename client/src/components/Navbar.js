...
import { NavLink as RouterNavLink } from "react-router-dom"; // Rename the import to avoid conflict
...
const Logo = styled(RouterNavLink)`
  // Rename the styled-component to avoid conflict
